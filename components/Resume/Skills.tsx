...
const Skills = () => {
  return (
    ...
    >
      {/* Programming Languages Skills Start */}
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <p className="text-sm text-designColor tracking-[4px] uppercase">
            Programming
          </p>
          <h2 className="text-3xl md:text-4xl font-bold">Languages & Technologies</h2>
        </div>
        <div className='className="mt-14 w-full flex flex-col gap-6'>
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">JAVASCIPT</p>
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">TYPESCIPT</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
      ...
      {/* Programming Languages Skills End */}


      {/* Frameworks & Technologies Skills Start */}
      <div className="w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <p className="text-sm text-designColor tracking-[4px] uppercase">
            Features
          </p>
          <h2 className="text-3xl md:text-4xl font-bold">Frameworks & Libraries</h2>
        </div>
      ...
      {/* Frameworks and Technologies End */}
    </motion.div>
  );
}
